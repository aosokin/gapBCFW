...
resultPath = fullfile(rootPath, 'results' , 'ocr_small_regPath' );
...
% APT_params();
% global APT_PARAMS;
% APT_PARAMS.exec_name = 'ocr_multiLambda';
% APT_PARAMS.host_name = { 'mem001' };
% APT_compile( 'ocr_multiLambda.m' );
% 
% APT_run('ocr_multiLambda.m', ...
%     dataPath_cell, resultPath_cell, lambda_grid, gap_threshold, ...
%     num_passes, time_budget, sample, useCache, cacheNu, cacheFactor, ...
%     maxCacheSize, stepType, gap_check, warm_start_type, rand_seed, datasetName, ...
%     'Memory', 5*1024, 'CombineArgs', 0, 'ClusterID', 2);

...
task_launcher('horse_medium_BCFW_hybrid', ...
...
% APT_params();
% global APT_PARAMS;
% APT_PARAMS.exec_name = 'horse_medium_BCFW_hybrid';
% APT_PARAMS.host_name = { 'mem001' };
% APT_compile( 'horse_medium_BCFW_hybrid.m' );
% 
% APT_run('horse_medium_BCFW_hybrid.m', ...
